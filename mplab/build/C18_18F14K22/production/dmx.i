...
extern unsigned char channelLevel[4];
...
if ((errflag == 1) && ( dmxState == 0x00) ) {
currentAdress = 0;
dmxState = 0x01;
return;
}

if ( (dmxState == 0x01) && (received == 0x00)) {
...
if (currentAdress >= 0 && currentAdress < 0 + 4) {

if ( channelLevel[currentAdress-0] == 0 && received != 0) {

dummy = LATA;

}

channelLevel[currentAdress-0] = received;

# 101
}


if (currentAdress == 0 + 4)
